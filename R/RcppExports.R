...
#'
#' @noRd
rcpp_get_sp_dists_par_tdz <- function(graph, vert_map_in, fromi, toi_in, heap_type, is_spatial) {
    .Call(`_dodgr_rcpp_get_sp_dists_par_tdz`, graph, vert_map_in, fromi, toi_in, heap_type, is_spatial)
}

...
void PF::PathFinder::init_arrays_tdz (
        std::vector <double>& d,
        std::vector <double>& w,
        std::vector <double>& t,
...
void PF::PathFinder::scan_edges_tdz (const DGraphEdge *edge,
        std::vector<double>& d,
        std::vector<double>& w,
        std::vector<double>& t,
        std::vector<double>& dz,
...
void PF::PathFinder::scan_edges_heur_tdz (const DGraphEdge *edge,
        std::vector<double>& d,
        std::vector<double>& w,
        std::vector<double>& t,
        std::vector<double>& dz,
...
void PF::PathFinder::Dijkstra_tdz (
        std::vector<double>& d,
        std::vector<double>& w,
        std::vector<double>& t,
        std::vector<double>& dz,
        ...
        const std::vector <size_t> &to_index)
{
    ...
    PF::PathFinder::init_arrays_tdz (d, w, t, dz, prev, m_open, m_closed, v0, n);
    m_heap->insert (v0, 0.0);
    ...
    while (m_heap->nItems() > 0) {
        ...
        edge = vertices [v].outHead;
        scan_edges_tdz (edge, d, w, t, dz, prev, m_open, m_closed, v);
...
void PF::PathFinder::AStar_tdz (std::vector<double>& d,
        std::vector<double>& w,
        std::vector<double>& t,
        std::vector<double>& dz,
        std::vector<long int>& prev,
        ...
        const std::vector <size_t> &to_index)
{
    ...
    while (m_heap->nItems() > 0) {
        ...
        edge = vertices [v].outHead;
        scan_edges_heur_tdz (edge, d, w, t, dz, prev, m_open, m_closed, v, heur);
...
void PF::PathFinder::Dijkstra_set_tdz (std::vector<double>& d,
        std::vector<double>& w,
        std::vector<double>& t,
        std::vector<double>& dz,
        std::vector<long int>& prev,
